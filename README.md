...
Solution: Go to settings of gmail app and create your custom signature. Add all other details in the right hand side of the box. Also make sure you change the signature defaults to your cutom signature name.
...
Solution: Go to google calendar and click on Create , then click Events. Select the time frame and maybe a message stating why you are out of office, then click okay.
...
Solution: Just go to Google drive, then click on New, and then click on New Folder. Type the name of the folder you about to create and then click Okay.
